...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="row">
            <div class="col-lg-9">
                <h1 class="app-page-title"> <span> <i class="fas fa-bars"></i> </span> Galleries </h1>
            </div>
            <div class="col-lg-3 mb-2">
                <div class="col-auto text-right">
                    <a class="btn app-btn-secondary" href="{{route('managment.galleries.create')}}"> <i class="fas fa-plus"></i> Create Gallery</a>
                </div>
            </div>
        </div>
