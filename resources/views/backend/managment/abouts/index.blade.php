...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="row">
            <div class="col-lg-9">
                <h1 class="app-page-title"> <span> <i class="fas fa-bars"></i> </span> Abouts</h1>
            </div>
            <div class="col-lg-3 mb-2">
                <div class="col-auto text-right">
                    <a class="btn app-btn-secondary" href="{{route('managment.abouts.create')}}"> <i class="fas fa-plus"></i> Create About</a>
                </div>
            </div>
        </div>
                                    ...
                                    <table class="table app-table-hover mb-0 text-left">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="cell"><a class="btn badge bg-warning" href="{{route('managment.abouts.edit',$row->id)}}">Edit</a></td>
                                                <td class="cell"><a class="btn badge bg-danger" href="#">Trashed</a></td>
                                                <td class="cell">
                                                    <form action="{{route('managment.abouts.destroy',$row->id)}}" method="post">
                                                        @csrf 
                                                        {{method_field('DELETE')}}
